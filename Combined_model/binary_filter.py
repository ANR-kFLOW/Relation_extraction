...
predicted_df.to_csv('predicted_as_causal.csv', index=False)
predicted_df.loc[predicted_df['num_rs'] > 0].to_csv('only_causal.csv', index=False)
predicted_df.loc[predicted_df['num_rs'] == 1].to_csv('only_causal_single.csv', index=False)