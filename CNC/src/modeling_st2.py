...
class SignalDetector(nn.Module):
    def __init__(self, model_and_tokenizer_path) -> None:
        super().__init__()
        self.tokenizer = AutoTokenizer.from_pretrained('/data/Youss/RE/CausalNewsCorpus/data/DFT/epoch_1/optimizer.bin')
        self.signal_detector = AutoModelForSequenceClassification.from_pretrained('/data/Youss/RE/CausalNewsCorpus/data/DFT/epoch_1/optimizer.bin')
...
class ST2ModelV2(nn.Module):
    def __init__(self, args):
        ...
        self.config = AutoConfig.from_pretrained('/data/Youss/RE/CausalNewsCorpus/albert-base-v2-config/config.json')
        self.model = AutoModel.from_pretrained('/data/Youss/RE/CausalNewsCorpus/data/DFT/epoch_1/optimizer.bin')
        self.tokenizer = AutoTokenizer.from_pretrained('/data/Youss/RE/CausalNewsCorpus/data/DFT/epoch_1/optimizer.bin')
