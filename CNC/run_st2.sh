...
/data/conda/lama3_new/bin/python3 run_st2.py \
  --dropout 0.3 \
  --learning_rate 2e-05 \
  ...
  --task_name ner \
  --do_train --do_test \
  --train_file "/data/Youss/RE/data/prob_max_typ_data/train_our_data_plus_atomic_filtered_columns.csv" \
  --validation_file "/data/Youss/RE/data/prob_max_typ_data/dev_our_data_plus_atomic_filtered_columns.csv" \
  --test_file "/data/Youss/RE/data/prob_max_typ_data/dev_our_data_plus_atomic_filtered_columns.csv" \
  --weight_decay 0.005 \
  --use_best_model
...
/data/conda/lama3_new/bin/python3 run_signal_cls.py \
