...
def test_model(data, path_to_model):
    with open('2stft_75.pth', 'rb') as f:
...
if __name__ == "__main__":
    path_to_model_pretrained='/data/Youss/RE/REBEL/models/model_cs.pth'
    # data = pd.read_csv('drive/MyDrive/rebel_format_v2.csv')
    # df_train, df_val = train_test_split(data, test_size=0.1, random_state=SEED)
    df_train = pd.read_csv('/data/Youss/RE/REBEL/data/news_data_with_cnc/train_augmented.csv')
