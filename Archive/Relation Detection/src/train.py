...
path_to_data='/data/Youss/RE/Binary_classification/data/'
# Load the dataset
train_data = pd.read_csv(path_to_data + 'train.csv')
val_data = pd.read_csv(path_to_data + 'validation.csv')
...
print("\nDistribution of num_rs column for train_data:")
print(train_data['num_rs'].value_counts(normalize=True))

print("\nDistribution of num_rs column for val_data:")
print(val_data['num_rs'].value_counts(normalize=True))
...
# Prepare dataloaders
train_dataset = CustomDataset(train_data['text'], train_data['num_rs'], tokenizer, MAX_LEN)
val_dataset = CustomDataset(val_data['text'], val_data['num_rs'], tokenizer, MAX_LEN)
